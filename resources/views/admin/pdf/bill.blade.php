...
-                    {{ $setting->adress }}
        ...
        <table cellspacing="1" cellpadding="3">
            ...
            <tr>
                <td>{{ $order->servicesNmae->id }} </td>
                <td>{{ $order->servicesNmae->name }}</td>
                <td>{{ $order->count }}</td>
                <td>{{ $order->servicesNmae->price }}
                    <span class="small">
                        ر.س
                    </span>
                </td>
                <td>{{ $order->count * $order->servicesNmae->price }}
                    <span class="small">
                        ر.س
                    </span>
                </td>
            ...
            <tr class="Colorth">
                ...
                <td class="noborder"></td>
                <td class="noborder"></td>
                <td class="noborder">{{ $order->count * $order->servicesNmae->price }}
                    <span class="small">
                        ر.س
                    </span>
                </td>
            ...
            <tr class="">
                ...
                <td class="noborder"></td>
                <td class="noborder"></td>
                <td class="noborder"> {{ $order->count * $order->servicesNmae->price - $order->payed }}
                    <span class="small">
                        ر.س
                    </span>
                </td>
