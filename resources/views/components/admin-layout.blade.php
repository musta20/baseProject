...
<html lang="en" dir="rtl" data-theme="light" data-layout-mode="fluid" data-topbar-color="light"
    data-sidenav-size="default" data-sidenav-color="dark" data-layout-position="fixed">
    ...
    <div class="wrapper">
        ...
        <div class="offcanvas offcanvas-end border-0" tabindex="-1" id="theme-settings-offcanvas">
            <div class="d-flex align-items-center bg-primary p-3 offcanvas-header">
                <h5 class="text-white m-0">اعداد الثيم</h5>
    ...
    <div class="col-4">
                                ...
                                <div class="col-4">
                                    ...
                                    <h5 class="font-14 text-center text-muted mt-2">Horizontal</h5>
                                            ...
                                            <h5 class="my-3 font-16 fw-bold">اختر لون الثيم </h5>
                                                    ...
                                                    <div class="col-4">
                                                        <div class="form-check card-radio">
                                                            <input class="form-check-input" type="radio"
                                                                name="data-theme" id="layout-color-light"
                                                                value="light">
                                                                ...
                                                                <span class="d-flex h-100">
                                                                    <span class="flex-shrink-0">
                                                                        <span
                                                                            ...
                                                                            <span
                                                                                class="d-block border border-3 w-100 mb-1"></span>
                                                                            <span
                                                                                class="d-block border border-3 w-100 mb-1"></span>
                                                                            <span
                                                                                class="d-block border border-3 w-100 mb-1"></span>
                                                        ...
                                                        <h5 class="font-14 text-center text-muted mt-2">مضيئ</h5>
                                                    </div>

                                                    <div class="col-4">
                                                        <div class="form-check card-radio">
                                                            <input class="form-check-input" type="radio"
                                                                name="data-theme" id="layout-color-dark" value="dark">
                                                                ...
                                                                <span class="d-flex h-100">
                                                                    <span class="flex-shrink-0">
                                                                        <span
                                                                            ...
                                                                            <span
                                                                                class="d-block border opacity-25 border-3 w-100 mb-1"></span>
                                                                            <span
                                                                                class="d-block border opacity-25 border-3 w-100 mb-1"></span>
                                                                            <span
                                                                                class="d-block border opacity-25 border-3 w-100 mb-1"></span>
                                                                    ...
                                                                    <span class="flex-grow-1">
                                                                        <span class="d-flex h-100 flex-column">
                                                                            <span
                                                                                class="bg-light-lighten d-block p-1"></span>
                                                                        </span>
                                                                    </span>
                                                                </span>
                                                            </label>
                                                        </div>
                                                        <h5 class="font-14 text-center text-muted mt-2">داكن</h5>
                                                    </div>
                                                </div>
                                            </div>

                                            <div id="layout-width">
                                                <h5 class="my-3 font-16 fw-bold"> نوع العرض</h5>
                                                ...
                                                <div class="row">
                                                    <div class="col-4">
                                                        ...
                                                        <h5 class="font-14 text-center text-muted mt-2">ملء</h5>
                                                    </div>
                                                 {{--    <div class="col-4" id="layout-boxed">
                                                    ...
                                                    <div class="col-4" id="layout-detached">
                                                            ...
                                                            <label class="form-check-label p-0 avatar-md w-100"
                                                                ...
                                                                <span class="d-flex h-100 flex-column">
                                                                    <span
                                                                        ...
                                                                        <span
                                                                            class="d-block p-1 bg-dark-lighten rounded me-1"></span>
                                                                        <span
                                                                            class="d-block border border-3 ms-auto"></span>
                                                                        <span
                                                                            class="d-block border border-3 ms-1"></span>
                                                                        <span
                                                                            class="d-block border border-3 ms-1"></span>
                                                                        <span
                                                                            class="d-block border border-3 ms-1"></span>
                                                                        ...
                                                                        <span class="flex-shrink-0">
                                                                            <span
                                                                                ...
                                                                                <span
                                                                                    class="d-block border border-3 w-100 mb-1"></span>
                                                                                <span
                                                                                    class="d-block border border-3 w-100"></span>
                                                                            </span>
                                                                        </span>
                                                                    </span>
                                                                    <span
                                                        ...
                                                        <h5 class="font-14 text-center text-muted mt-2">منفصل</h5>
                                                    </div>
                                                </div>
                                            </div>

                                            <h5 class="my-3 font-16 fw-bold"> لون القائمة الرئسية</h5>
                                            ...
                                            <div id="sidebar-color">
                                                <h5 class="my-3 font-16 fw-bold"> لون القائمة الجانبية</h5>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-4">
                                                        ...
                                                        <h5 class="font-14 text-center text-muted mt-2">اللون الافتراضي</h5>
                                                    </div>
                                                </div>
                                            </div>

                                            <div id="sidebar-size">
                                                <h5 class="my-3 font-16 fw-bold"> حجم القائمة الجانبية</h5>
                                                ...
                                                <div class="row">
                                                    <div class="col-4">
                                                        ...
                                                        <h5 class="font-14 text-center text-muted mt-2">الافتراضي</h5>
                                                    </div>
                                                    ...
                                                    <div class="col-4">
                                                        ...
                                                        <h5 class="font-14 text-center text-muted mt-2">متوسطة</h5>
                                                    </div>
                                                    ...
                                                    <div class="col-4">
                                                        ...
                                                        <h5 class="font-14 text-center text-muted mt-2">مصغرة</h5>
                                                    </div>
                                                    ...
                                                    <div class="col-4">
                                                        ...
                                                        <h5 class="font-14 text-center text-muted mt-2"> اظهار عند التمرير</h5>
                                                    </div>
                                                    ...
                                                    <div class="col-4">
                                                        ...
                                                        <h5 class="font-14 text-center text-muted mt-2"> مخفية
                                                        </h5>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div id="layout-position">
                                                <h5 class="my-3 font-16 fw-bold">موقع القائمة </h5>
                                                ...
                                                <div class="btn-group radio" role="group">
                                                    ...
                                                    <label class="btn btn-light w-sm"
                                                        for="layout-position-fixed">ثايت</label>

                                                    <input type="radio" class="btn-check"
                                                        name="data-layout-position" id="layout-position-scrollable"
                                                        value="scrollable">
                                                    <label class="btn btn-light w-sm ms-0"
                                                        for="layout-position-scrollable">متحرك</label>
                                                </div>
                                            </div>

                                            <div id="sidebar-user">
                                                <div class="d-flex justify-content-between align-items-center mt-3">
                                                    <label class="font-16 fw-bold m-0" for="sidebaruser-check">اظهار المشتخدم في القائمة</label>
                        ...
                        <div class="simplebar-placeholder" style="width: auto; height: 1335px;"></div>
                    </div>
