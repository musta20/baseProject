            ...
            <div class="navbar-custom topnav-navbar">
                <div class="container-fluid detached-nav">
                    ...
                    <div class="logo-topbar">
                        <!-- Logo light -->
                        <a href="https://coderthemes.com/hyper_2/saas/index.html" class="logo-light">
                            <span class="logo-lg">
                        ...
                        <!-- Logo Dark -->
                        <a href="https://coderthemes.com/hyper_2/saas/index.html" class="logo-dark">
                            <span class="logo-lg">
                            ...
                            <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated dropdown-lg py-0">
                                <div class="p-2 border-top-0 border-start-0 border-end-0 border-dashed border">
                                    <div class="row align-items-center">
                                        <div class="col">
                                            <h6 class="m-0 font-16 fw-semibold"> Notification {{getNotif()}}</h6>
                                        </div>
                                        <div class="col-auto">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <div class="notify-icon">
                                                        <img src="{{asset('Dashboard/avatar-2.jpg')}}" class="img-fluid rounded-circle" alt="">
                                                    </div>
                                                </div>
                                                <div class="flex-grow-1 text-truncate ms-2">
                                    ...
                                    <a href="javascript:void(0);" class="dropdown-item p-0 notify-item card read-noti shadow-none mb-2">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <div class="notify-icon">
                                                        <img src="{{asset('Dashboard/avatar-4.jpg')}}" class="img-fluid rounded-circle" alt="">
                                                    </div>
                                                </div>
                                                <div class="flex-grow-1 text-truncate ms-2">
...
{{--                         <li class="dropdown notification-list d-none d-sm-inline-block">
 ...
 --}}
                        ...
                        <li class="notification-list d-none d-md-inline-block">
                            <a class="nav-link" href="https://coderthemes.com/hyper_2/saas/index-rtl.html" data-toggle="fullscreen">
    ...
    @auth
                        ...
                        <li class="dropdown notification-list">
                            ...
                            href="https://coderthemes.com/hyper_2/saas/index-rtl.html#" role="button" aria-haspopup="false"
                             aria-expanded="false">
                                <span class="account-user-avatar"> 
                                    <img src="{{url('Dashboard/avatar-1.jpg')}}" alt="user-image" class="rounded-circle">
                                </span>
                                <span>
                    ...
                    <div class="app-search dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-animated dropdown-lg" id="search-dropdown">
                            ...
                            <div class="notification-list">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item">
                                    <div class="d-flex">
                                        <img class="d-flex me-2 rounded-circle" src="{{asset('Dashboard/avatar-2.jpg')}}" alt="Generic placeholder image" height="32">
                                        <div class="w-100">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item">
                                    <div class="d-flex">
                                        <img class="d-flex me-2 rounded-circle" src="{{asset('Dashboard/avatar-5.jpg')}}" alt="Generic placeholder image" height="32">
                                        <div class="w-100">
