<x-layout>
    ...
    @if (!$slides->isEmpty())
        <section dir="ltr" class="swiper-container2">
            ...
            <link rel="stylesheet" href="style/mainContact.css" />
        </section>
    @endif
 ...
 --}}
                ...
                <center>
                    <a href="service/{{ $item->id }}" class="btn">عرض</a>
                </center>
            </div>
        @endforeach
    </section>
    ...
    @if (!$custmerSlide->isEmpty())
        ...
        <section class="ourCustmer">
            <h3>عملاؤنا</h3>
            <p>
                نقترب من فكرك، نرى بعينك، ونتبنى توجهك لنصنع التغيير معًا ! بإتباع نهج متميز ودقيق، نسعى معًا لإحداث
                نقلــة غير
