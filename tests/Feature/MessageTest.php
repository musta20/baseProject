...
class MessageTest extends TestCase
{
     ...
     * @test
     */
    public function it_shows_inbox_messages()
    {
     ...
     * @test
     */
    public function it_shows_sent_messages()
    {
        $user = User::factory()->withRole(UserRole::Admin->value)->create();
        $user2 = User::factory()->withRole(UserRole::Admin->value)->create();
        $this->actingAs($user);
     ...
     * @test
     */
    public function it_shows_create_message_form()
    {
        $user = User::factory()->withRole(UserRole::Admin->value)->create();
        $this->actingAs($user);
     ...
     * @test
     */
    public function it_shows_error_for_unauthorized_message_access()
    {
        $user = User::factory()->withRole(UserRole::Admin->value)->create();
        $this->actingAs($user);
     ...
     * @test
     */
    public function it_shows_404_for_non_existent_message()
    {
        $user = User::factory()->withRole(UserRole::Admin->value)->create();
        $this->actingAs($user);
