...
class ReportTest extends TestCase
{
     ...
     * @test
     */
    public function authenticated_user_can_access_report_order_page()
    {
     ...
     * @test
     */
    public function authenticated_user_can_access_report_cash_page()
    {
        $this->authenticateUser();
     ...
     * @test
     */
    public function authenticated_user_can_access_report_bill_page()
    {
        $this->authenticateUser();
     ...
     * @test
     */
    public function unauthenticated_user_cannot_access_report_main_page()
    {
     ...
     * @test
     */
    public function authenticated_user_can_view_order_reports_with_filters()
    {
        $user = $this->authenticateUser();
